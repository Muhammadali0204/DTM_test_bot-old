...
tosh_v = InlineKeyboardButton(
    text="Toshkent viloyati", callback_data="Toshkent viloyati"
)


viloyat_keyboard = InlineKeyboardMarkup(row_width=2).add(
    andi, bux, far, jiz, nam, qash, nuk, sam, sir, sur, xor, nav, tosh_sh, tosh_v
)
