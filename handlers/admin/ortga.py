...
@dp.message_handler(
    ...
    state=[
        ...
        "copy",
        "admin test turi",
        "add test asosiy fayl",
        "add test blok fayl",
        "add test majburiy fayl",
        "add test asosiy javob",
        "add test blok javob",
        "add test majburiy javob",
        "javoblarni yuborishi kerak",
    ],
    chat_id=ADMINS,
)
...
@dp.callback_query_handler(
    text="ortga", state=["add fan blok", "add fan asosiy"], chat_id=ADMINS
)
